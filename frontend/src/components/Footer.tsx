                                    ...
                                    <AlertDialog.Trigger className='items-center!'>
                                        <Button 
                                            className={`bg-white! text-[#6F73EE]! font-normal! text-[16px]! items-center! py-7! px-6! transition-colors duration-200! ${
                                                !isEmailValid || isSubscribeLoading ? 'opacity-50 cursor-not-allowed!' : 'cursor-pointer!'
                                            }`}
                                            onClick={handleSubscribe}
                                            disabled={!isEmailValid || isSubscribeLoading}
                                        >
                                            {isSubscribeLoading ? 'Отправка...' : 'Подписаться'}
                                        </Button>
                                    </AlertDialog.Trigger>
                                    <Modal open={isSubscribeDialogOpen} onOpenChange={setIsSubscribeDialogOpen} maxWidth="800px">
                                        <div>
                                            <ModalClose onClick={handleCloseSubscribeDialog} />
                    ...
                    <div className="lg:hidden flex flex-col items-center gap-6 text-center px-4">
                        ...
                        <div className="w-full max-w-[400px]">
                            <AlertDialog.Root open={isSubscribeDialogOpen} onOpenChange={setIsSubscribeDialogOpen}>
                                ...
                                <Modal open={isSubscribeDialogOpen} onOpenChange={setIsSubscribeDialogOpen} maxWidth="800px" className='max-w-[95vw] mx-auto'>
                                    <div className='p-6'>
                                        <ModalClose onClick={handleCloseSubscribeDialog} />
