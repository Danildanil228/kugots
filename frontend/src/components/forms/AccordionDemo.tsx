      ...
      <div className="flex justify-center">
        ...
        >
          <AccordionItem value="item-1">
            <AccordionTrigger className="hover:no-underline [&[data-state=open]>svg]:rotate-45">
          ...
          <AccordionItem value="item-2">
            ...
            <AccordionContent className="flex flex-col gap-4 text-balance">
              ...
              <div className="grid gap-4">
                ...
                <p>Расширенная гарантия и сервис: Мы обеспечиваем полноценное гарантийное и послегарантийное обслуживание через собственные сервисные центры и удаленную поддержку специалистов.</p>
                <p>Проверка качества: Каждый самокат перед отправкой тестируется, чтобы вы получили полностью исправное устройство.</p>
                <p>Консультация и поддержка: Наши специалисты всегда готовы помочь с выбором, проконсультировать по эксплуатации и оперативно решить любой вопрос.</p>
                <p>Надежность и ответственность: Мы являемся официальными дилерами и несем полную ответственность перед покупателями, что подтверждается всеми необходимыми документами.</p>
